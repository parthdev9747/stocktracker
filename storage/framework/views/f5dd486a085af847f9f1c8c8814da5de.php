...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(URL::asset('build/libs/fullcalendar/main.min.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchHolidays() {
                fetch('<?php echo e(route('holidays.data')); ?>')
            ...
            function syncHolidays() {
                ...
                fetch('<?php echo e(route('holidays.sync')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\stockapp\resources\views/holidays/index.blade.php ENDPATH**/ ?>