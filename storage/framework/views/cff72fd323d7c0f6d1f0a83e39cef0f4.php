                                    ...
                                    <div class="card h-100 card-hover">
                                        <div class="card-header p-3 pb-0">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <span class="badge bg-gradient-primary mb-2"><?php echo e(substr($index->index_code, 0, 2)); ?></span>
                                                    <h6 class="mb-0"><?php echo e($index->index_code); ?></h6>
                                                </div>
                                                <div class="text-end">
                                                    <div class="dropdown">
                                                        <a href="javascript:;" class="text-secondary" id="dropdownMenuButton<?php echo e($index->id); ?>" data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="fas fa-ellipsis-v"></i>
                                                        </a>
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo e($index->id); ?>">
                                                            <li><a class="dropdown-item" href="<?php echo e(route('index-names.show', $index->id)); ?>">View Details</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-3 pt-2">
                                            <div class="index-name mb-3">
                                                <h5 class="text-gradient text-primary mb-0"><?php echo e($index->index_name); ?></h5>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="text-xs text-muted">
                                                    <i class="far fa-clock me-1"></i>
                                                    Updated <?php echo e($index->updated_at->diffForHumans()); ?>

                                                </span>
                                                <a href="<?php echo e(route('index-names.show', $index->id)); ?>" class="btn btn-link text-primary text-sm mb-0 px-0 ms-auto">
                                                    View Details
                        ...
                        <div class="row">
                            ...
                            <?php $__currentLoopData = $categories->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $indices): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div
                                        class="card card-background shadow-none card-background-mask-<?php echo e($colors[array_rand($colors)]); ?> h-100">
                                        <div class="full-background"
                                            style="background-image: url('/assets/img/curved-images/white-curved.jpeg')">
                                        </div>
                                        <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                            <h5 class="text-white font-weight-bolder mb-4 pt-2"><?php echo e($category); ?></h5>
                                            <p class="text-white text-sm"><?php echo e($indices->count()); ?> indices</p>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#refreshData').on('click', function() {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('index-names.refresh')); ?>',
                        type: 'POST',
                        data: {
